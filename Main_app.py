...
#The main application, it uses the '.ui' file generated by qt designer directly
#I didn't bother to covert the '.ui' file to a python file, I just worked with it directly

#Create the main window and use the .ui file 
class Ui(QtWidgets.QMainWindow):
   ...
   #This function is used when a user clicks ok or cancel on the popup window
    def popup_clicked(self, i):
        self.remove_duplicates(self.dir)

    #popup window when the user clickes scan
...
#Some unsolved errors and issues include:
# Delayed Scanning 
# Add a scanning widget to graphically show the speed of the process
# Change the crappy UI
# Program the drag and drop functionality
